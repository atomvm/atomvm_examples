...
This target will create the `ledc_example.avm` file in the `./_build/default/lib/` directory.
...
To run this application on a generic UNIX platform, supply the path to the generated AVM file, together with the AtomVM core library
    ...
    shell% /path/to/AtomVM ./_build/default/lib/ledc_example.avm /path/to/atomvmlib.avm
